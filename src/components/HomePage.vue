...
const onFaqToggle = (payload: { question: string; action: 'open' | 'close'; index: number }) => {
  analytics.trackFAQInteraction(payload.question, payload.action)
}
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Sim! Você tem 07 dias para trocar sem custo adicional. Basta entrar em contato conosco pelo WhatsApp.'
  },
  {
...
const currentPrice = computed(() => {
  return quantityMode.value === 'single' ? 297 : 494
})

const priceText = computed(() => {
  return quantityMode.value === 'single' ? 'R$ 297' : 'R$ 494'
})

const savings = computed(() => {
  if (quantityMode.value === 'combo') {
    const singlePrice = 297 * 2
    const comboPrice = 494
...
<template>
  <div id="app" class="min-h-screen bg-[#0B0B0C] text-[#F5F5F5]">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center space-x-2 sm:space-x-4">
            <div class="text-right hidden sm:block">
              <div v-if="quantityMode === 'combo'" class="text-sm text-[#E8E2D6]">Economia de 16,8%</div>
    ...
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div class="relative z-10 max-w-7xl mx-auto px-4 pt-8 sm:pt-12 grid lg:grid-cols-2 gap-4 lg:gap-6 items-stretch">
        ...
        <div class="text-center lg:text-left">
          ...
          <div class="text-2xl font-bold text-[#C8AE7D]">Combo 2 pares: R$ 494</div>
          <div class="text-sm text-green-400 font-medium">Economia de 16,8% • R$100 de desconto</div>
            </div>
          </div>
      ...
      <div class="max-w-6xl mx-auto">
        <div class="text-center mb-12">
          ...
          <p class="text-lg sm:text-xl text-[#E8E2D6] max-w-2xl mx-auto mb-8">
            Monte sua combinação perfeita e economize 16,8%
          </p>
          ...
          <div class="bg-[#C8AE7D]/10 border border-[#C8AE7D]/20 rounded-2xl p-6 max-w-md mx-auto mb-12">
            ...
            <div v-if="quantityMode === 'combo'" class="text-green-400 font-semibold">Economia de R$ {{ savings }} (16,8%)</div>
          </div>
        </div>
          ...
          <div class="grid md:grid-cols-2 gap-4">
            ...
            >
              ...
              <div class="text-center mt-2">
                ...
                <div class="text-2xl font-bold text-[#C8AE7D] mb-1">R$ 494</div>
                <div class="text-sm text-green-400 font-semibold mb-1">Economize R$ 197</div>
                <div class="text-xs text-[#E8E2D6]/70">16,8% de desconto</div>
              </div>
        ...
        <div class="max-w-5xl mx-auto">
          ...
          <div :class="[
            ...
            quantityMode === 'single' 
              ...
              : 'grid md:grid-cols-2 lg:grid-cols-3 items-start'
          ]">
            <!-- Par 1 -->
            ...
            <!-- Resumo e CTA -->
            <div class="bg-gradient-to-br from-[#C8AE7D]/10 to-[#E8E2D6]/10 backdrop-blur-sm border border-[#C8AE7D]/20 rounded-2xl overflow-hidden h-full flex flex-col">
              <!-- Header do Resumo -->
              <div class="bg-gradient-to-r from-[#C8AE7D]/20 to-[#E8E2D6]/20 px-4 sm:px-6 py-4 border-b border-[#C8AE7D]/20">
                <div class="flex items-center">
                  <svg class="w-5 h-5 text-[#C8AE7D] mr-2" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div class="p-4 sm:p-6 flex flex-col flex-1">
                ...
                <!-- Divisor -->
                <div class="border-t border-[#C8AE7D]/20 my-4"></div>

                <!-- Benefícios em Caixas -->
                <div class="grid grid-cols-1 gap-2 mb-4">
                  <div class="bg-gradient-to-r from-[#C8AE7D]/10 to-[#E8E2D6]/10 border border-[#C8AE7D]/20 rounded-lg p-2 flex items-center">
                    <div class="bg-[#C8AE7D] rounded-full p-1.5 mr-2">
                      <svg class="w-3 h-3 text-[#0B0B0C]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                      </svg>
                    </div>
                    <div>
                      <p class="text-[#E8E2D6] font-medium text-xs">Frete Grátis</p>
                      <p class="text-[#E8E2D6]/70 text-xs">Na compra de 2 pares</p>
                    </div>
                  </div>
                  ...
                  <div class="bg-gradient-to-r from-[#C8AE7D]/10 to-[#E8E2D6]/10 border border-[#C8AE7D]/20 rounded-lg p-2 flex items-center">
                    ...
                    <div>
                      <p class="text-[#E8E2D6] font-medium text-xs">Troca Gratuita</p>
                      <p class="text-[#E8E2D6]/70 text-xs">07 dias para trocar</p>
                    </div>
                  </div>
                  ...
                  <div class="bg-gradient-to-r from-[#C8AE7D]/10 to-[#E8E2D6]/10 border border-[#C8AE7D]/20 rounded-lg p-2 flex items-center">
                    ...
                    <div>
                      <p class="text-[#E8E2D6] font-medium text-xs">Garantia</p>
                      <p class="text-[#E8E2D6]/70 text-xs">6 meses de proteção</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="mt-auto">
                  ...
                  <div class="text-center mb-4">
                    ...
                    <div v-if="quantityMode === 'combo'" class="text-sm text-green-400 font-medium">Economia de 16,8%</div>
                  </div>
      ...
      <div class="max-w-6xl mx-auto">
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div class="text-center">
            ...
            <h3 class="text-xl font-bold mb-4">07 Dias Corridos</h3>
            <p class="text-[#E8E2D6] leading-relaxed">
    ...
    <!-- FAQ Enxuto -->
    <FAQSection :faqs="faqs" @faq-toggle="onFaqToggle" />
        ...
        <div class="bg-gradient-to-br from-[#C8AE7D]/20 to-[#E8E2D6]/20 border border-[#C8AE7D]/30 rounded-3xl p-12">
          ...
          <div class="mb-8">
            ...
            <div v-if="quantityMode === 'combo'" class="inline-flex items-center bg-green-500/20 border border-green-500/30 rounded-full px-4 py-2">
              <span class="text-green-400 font-bold text-lg">Economia de 16,8% • R$ {{ savings }} menos</span>
            </div>
          </div>
        ...
        <div class="text-center mb-8">
          ...
          <div class="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-8 mb-6">
            ...
            <a href="https://wa.me/5511999999999" class="flex items-center text-[#E8E2D6] hover:text-[#C8AE7D] transition-colors">
              ...
              <span class="font-medium">(37) 9947-9108</span>
            </a>
            ...
            <a href="https://instagram.com/majestad" class="flex items-center text-[#E8E2D6] hover:text-[#C8AE7D] transition-colors">
              ...
              <span class="font-medium">@use.majestad</span>
            </a>
          </div>
        </div>
