        ...
        <div class="space-y-6">
          ...
          <div class="bg-[#C8AE7D]/10 border border-[#C8AE7D]/20 rounded-3xl p-6">
            ...
            <div 
              ...
              class="mt-4 text-[#E8E2D6] leading-relaxed"
            >
              Claro! Sua <strong class="text-[#C8AE7D]">primeira troca é totalmente grátis</strong> em até 07 dias. Basta entrar em contato pelo WhatsApp e nossa equipe cuida de tudo. Processo simples, sem burocracia.
            </div>
          </div>
